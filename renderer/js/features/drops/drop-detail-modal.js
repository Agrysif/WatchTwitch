        ...
        <div style="display: flex; gap: 32px; align-items: start; flex-wrap: wrap;">
          ...
          <div style="flex-shrink: 0; width: 100%; max-width: 320px; margin: 0 auto;">
            ...
            <div style="margin-top: 16px; display: flex; gap: 8px;">
              <div style="flex: 1; background: rgba(0,0,0,0.3); padding: 12px; border-radius: 8px; text-align: center; border: 1px solid rgba(255,255,255,0.1);">
            ...
            <!-- Статус -->
            <div style="margin-top: 8px; background: rgba(0,0,0,0.3); padding: 12px; border-radius: 8px; text-align: center; border: 1px solid rgba(255,255,255,0.1);">
          ...
          <div style="flex: 1; min-width: 250px;">
            ...
            <div style="display: flex; flex-direction: column; gap: 12px;">
              ...
              <!-- Игра -->
              <div style="background: rgba(0,0,0,0.3); padding: 14px; border-radius: 10px; border: 1px solid rgba(255,255,255,0.1);">
                <div style="display: flex; align-items: center; gap: 10px;">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" style="color: #9147ff; flex-shrink: 0;">
              ...
              <div style="background: rgba(0,0,0,0.3); padding: 14px; border-radius: 10px; border: 1px solid rgba(255,255,255,0.1);">
                <div style="display: flex; align-items: center; gap: 10px;">
                  ...
                  <div style="flex: 1;">
                    ...
                    <div style="height: 6px; background: rgba(255,255,255,0.12); border-radius: 3px; overflow: hidden; margin: 6px 0 4px;">
              ...
              <!-- Дата получения -->
              <div style="background: rgba(0,245,147,0.1); padding: 14px; border-radius: 10px; border: 1px solid rgba(0,245,147,0.2);">
                <div style="display: flex; align-items: center; gap: 10px;">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" style="color: #00f593; flex-shrink: 0;">
                  ...
                  <div style="flex: 1;">
                    ...
                    <div style="font-size: 15px; font-weight: 600; color: #00f593;">${claimedDate || '—'}</div>
                  </div>
                </div>
              </div>
